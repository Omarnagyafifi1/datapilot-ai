...
from sqlalchemy import Column, DateTime, Float, MetaData, String, Table, create_engine, select, insert, desc, func
...
class HistoryService:
    def save_query(self, question: str, source_id: str, status: str, latency: float) -> str:
        query_id = str(uuid4())
        payload = {
            "id": query_id,
            "question": question,
